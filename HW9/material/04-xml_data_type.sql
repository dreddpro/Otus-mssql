...
SET @x = ( 
  ...
  (BULK 'E:\OTUS\Курс MS SQL Server\10 XML JSON\10 XML JSON\10-xml_json\demo\04-xml_data_type.xml',
   SINGLE_CLOB) AS d);
...
DECLARE @x XML;
SET @x = (SELECT * FROM OPENROWSET (BULK 'E:\OTUS\Курс MS SQL Server\10 XML JSON\10 XML JSON\10-xml_json\demo\04-xml_data_type.xml', SINGLE_BLOB)  AS d);
